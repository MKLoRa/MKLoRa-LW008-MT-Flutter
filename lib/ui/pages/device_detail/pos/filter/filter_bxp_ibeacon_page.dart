  ...
  Future<void> _save() async {
    ...
    await runWithBleLoading(context, () async {
      ...
      final ok = (await Future.wait([
        api.writeFilterBxpIbeaconUuid(Lw008ParamHelpers.hexToBytes(_uuid.text.trim())),
        api.writeFilterBxpIbeaconMajorRange(_majorRangePayload()),
        api.writeFilterBxpIbeaconMinorRange(_minorRangePayload()),
